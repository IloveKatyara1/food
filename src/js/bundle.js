...
function calc() {
  function pasteDataInCalc() {
    ...
    caloriesInputs.forEach(function (input) {
...
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../services/services */ "./src/js/services/services.js");
...
function card(url, classBlock, parentElem) {
  var AddNewCard = /*#__PURE__*/function () {
    function AddNewCard(img, title, text, price, alt, parent) {
      ...
      value: function render() {
        ...
        if (this.classes.length == 0) {
          ...
          this.classes.forEach(function (item) {
            if (item == 'menu__item') {
              addClasses(_this.classes);
            } else {
              calc += 1;
              if (_this.classes.length - calc <= 0) {
                _this.classes.unshift('menu__item');
                addClasses(_this.classes);
              }
            }
          });
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_14__.getData)(url).then(function (data) {
...
function forms(modal, url) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_10__.postData)(url, json).then(function (data) {
        console.log(data);
        addThanksModal(massage.success);
      })["catch"](function () {
        return addThanksModal(massage.failure);
      })["finally"](function () {
        massageBlock.remove();
        form.reset();
      });
      var massageBlock = document.createElement('img');
  ...
  function addThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_9__.showModal)(modal);
    ...
    window.removeEventListener('scroll', _modal__WEBPACK_IMPORTED_MODULE_9__.showModalByScroll);
    clearInterval(_modal__WEBPACK_IMPORTED_MODULE_9__.timeoutId);
    setTimeout(function () {
      thanksModal.remove();
      dialog.classList.remove('hide');
      (0,_modal__WEBPACK_IMPORTED_MODULE_9__.removeModal)(modal);
    }, 4000);
  }
}
...
/* harmony export */   "timeoutId": () => (/* binding */ timeoutId)
/* harmony export */ });
...
var timeoutId = setTimeout(function () {
  return showModal(modalTimeout, timeoutId, showModalByScroll);
}, 5000);
...
function removeModal(modal) {
  ...
  var thanks = document.querySelector('.thanks_modal');
  if (thanks) {
    thanks.remove();
...
function modal(modalSection, btnShowModalSection) {
  var btnShowModal = document.querySelectorAll(btnShowModalSection),
    modal = document.querySelector(modalSection);
  modalTimeout = modal;
  btnShowModal.forEach(function (btn) {
    btn.addEventListener('click', function () {
      return showModal(modal, timeoutId, showModalByScroll);
    });
  });
...
function slides(_ref) {
  var slidesElem = _ref.slidesElem,
    prevBtnElem = _ref.prevBtnElem,
    nextBtnElem = _ref.nextBtnElem,
    counterElem = _ref.counterElem,
    totalElem = _ref.totalElem;
  function changeSlide(pOrM) {
    slides[num].classList.remove('show');
    num += pOrM;
    if (num > slides.length - 1) {
      counter.textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_3__.getZero)(1);
      num = 0;
    } else if (num < 0) {
      counter.textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_3__.getZero)(slides.length);
      num = slides.length - 1;
    } else {
      counter.textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_3__.getZero)(num + 1);
    }
  ...
  function removeActiveIndicator() {
    indicators.forEach(function (ind) {
      return ind.style.opacity = '.5';
    });
  }
  var slides = document.querySelectorAll(slidesElem),
  ...
  var num = 0;
  counter.textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_3__.getZero)(num + 1);
  total.textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_3__.getZero)(slides.length);
  slides[num].classList.add('show');
...
function tabs(tabsBlock, tabsContentBlock, tabsParentBlock, activeClass) {
  var tabs = document.querySelectorAll(tabsBlock),
    tabsContent = document.querySelectorAll(tabsContentBlock),
    tabsParent = document.querySelector(tabsParentBlock);
  ...
  tabsParent.addEventListener('click', function (event) {
    ...
    if (target && target.classList.contains(tabsBlock.slice(1))) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("\u0421\u0442\u0430\u043B\u0430\u0441\u044F \u043F\u043E\u043C\u0438\u043B\u043A\u0430 ".concat(res.status, ", \u0434\u0435\u0442\u0430\u043B\u044C\u043D\u0456\u0448\u0435 \u0434\u0438\u0432\u0438\u0442\u0438\u0441\u044F \u0432 \u043A\u043E\u043D\u0441\u043E\u043B\u0456"));
        case 5:
          _context2.next = 7;
          return res.json();
        case 7:
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_card__WEBPACK_IMPORTED_MODULE_2__["default"])('http://localhost:3000/menu', 'menu__item', '.menu .container');
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('2023-03-20');
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_6__["default"])(document.querySelector('.modal'), 'http://localhost:3000/requests');
});
})();
